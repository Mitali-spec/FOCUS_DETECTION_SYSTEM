...
#Eye Aspect Ratio (EAR). If the distance between your upper and lower eyelids stays too small for a certain amount of time, the system will trigger a "SLEEPING" state and sound a loud alarm to wake you up.
EYE_CLOSED_THRESHOLD = 0.2  # If Eye Aspect Ratio (EAR) is below this, eyes are closed
SLEEP_TIME_THRESHOLD = 3.0  # If eyes are closed for 3 seconds, you're sleeping
